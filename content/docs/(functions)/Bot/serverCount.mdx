...
<Discord>
    <Message>!!exec I am in $serverCount servers.</Message>
    <Message bot>I am in 15000 servers.</Message>
</Discord>

**Difficulty:** <Badge type="tip" text="Easy" vertical="middle" />

**Tags:** <Tag text="Server Count"/> <Tag text="Bot Server Count"/> <Tag text="OS"/> <Tag text="Stats"/>
