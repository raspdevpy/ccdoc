...
<Discord>
    <Message>
        ...
        $imageLoadFromURL[avatar;$replaceText[$authorAvatar;webp;png]]
        $imageFill[gray] $imageFill[transparent;100;100;100;100]
        $imageDrawBack[avatar;50;50;200;200] $image[$imageOutput]
    </Message>
    <Message bot>
        <Embed image="https://i.imgur.com/r92gm8i.png"></Embed>
    </Message>
</Discord>
