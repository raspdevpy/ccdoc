...
<Discord>
    <Message>
        ...
        the author's avatar $imageDraw[avatar;0;0;300;300] // Draw the avatar
        onto the image frame $image[$imageOutput] // Output the resulting image
    </Message>
    <Message bot>
