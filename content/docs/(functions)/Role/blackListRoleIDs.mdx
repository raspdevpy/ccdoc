...
- `$ban[$mentioned[1]]`: This line executes the ban command, banning the mentioned user. It only executes if the user does _not_ have a blacklisted role.
- `Successfully banned user.`: This line sends a confirmation message after a successful ban.

<Discord>
    <Message>!ban @RAKE</Message>
    <Message bot>You are not authorized to use this command!</Message>
</Discord>

<Callout type="info" title={"Note"}>

You can send an embed instead of a simple text message by using the [Message Curl Format](/Other/curl) in your error message.

</Callout>

**Function difficulty:** <Badge type="tip" text="Easy" vertical="middle" />

**Tags:** <Tag text="Blacklist"/> <Tag text="Roles"/>
