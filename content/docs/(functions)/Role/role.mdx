...
* `thirdColor`: The role's tertiary color as a 10-base number, if it has a tertiary color.
* `primaryHex`: The role's primary color in hexadecimal format.
* `secondaryHex`: The role's secondary color in hexadecimal format, or `undefined` if no secondary color is set.
* `tertiaryHex`: The role's tertiary color in hexadecimal format, or `undefined` if no tertiary color is set.
