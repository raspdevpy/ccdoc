...
*   **permission;permission;...:**  A list of permissions to grant to the role. Refer to the [Permission List](/CodeReferences/ref.permissions_list) for valid permission names.
...
<Callout type="info" title={"Available Permissions"}>

For a comprehensive list of available permissions, please see the [Permission List](/CodeReferences/ref.permissions_list).
...
**Tags:** <Tag text="Role"/> <Tag text="Create"/> <Tag text="Create Role"/> <Tag text="Make Role"/> 
