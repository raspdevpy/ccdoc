...
*   **permission;permission;...:**  A list of permissions to grant to the role. Refer to the [Permission List](/Other/permission-list) for valid permission names.
...
For a comprehensive list of available permissions, please see the [Permission List](/Other/permission-list).
