...
## Usage
```cc
$humanizeMS[milliseconds; limit (optional); separator (optional)]
```
...
<Callout type="info" title={"Other Timezones"}>

Date functions by default use the UTC timezone, but you can change it. [Learn More](/Date/timezone)

</Callout>

**Function Difficulty:** <Badge type="tip" text="Easy" vertical="middle" />

**Tags:** <Tag text="HumanizeMS"/>
