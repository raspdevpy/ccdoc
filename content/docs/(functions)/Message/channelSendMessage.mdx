...
You can send more complex messages with features like footers and fields by using the [Message Curl Format](/Other/curl). This format allows for more detailed control over your messages.
