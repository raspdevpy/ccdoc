...
- **`forward-*`**: Retrieves information from the original message contained within a forwarded message ([Read more here](#forwarded-message)).

## Example

<Discord>
    <Message>!!exec $msg[$channelID;79890890890809;content]</Message>
    <Message bot>Old Messsage</Message>
</Discord>

## Forwarded Message

You can use `forward-*` to get the forward message data instead of the original message, Replace \* with any supported property from the following categories:

- Channel Information
- Message Content, except `cleancontent`
- Message Metadata, except `thread`, `reference`, and `pinned`
- Attachment Information
- Embed Information
- Sticker Information
- Components
...
```cc
$msg[channelid;messageid;forward-content]
```

returns the content of the original forwarded message.

Other examples:

```cc
$msg[channelid;messageid;forward-author]
$msg[channelid;messageid;forward-embed]
$msg[channelid;messageid;forward-components]
```

`forward-*` properties are only available when the target message is a forwarded message.

**Function difficulty:** <Badge type="tip" text="Easy" vertical="middle" />

**Tags:** <Tag text="Compact"/> <Tag text="Message"/>
