...
<Callout type="info" title={"{key=value} what is this for a syntax?"}>
...
This syntax is called curl args.It is really similar to curl message.Especially new Functions support it ,you can use !!func `function name` to check if it supports curl arguments.
 [Learn more](/Other/curl)

</Callout>

<Callout type="info" title={"Do you want to add a menu inside a Function as a parameter, like `$sendMessage[text]`?"}>
...
Using the menu as trigger check here to [learn more](/Trigger/menu).

</Callout>

**Function difficulty:** <Badge type="warning" text="Medium" vertical="middle" /> 

**Tags:** <Tag text="Select Menu"/> <Tag text="Component"/> 
