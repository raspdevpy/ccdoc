...
This function supports the [Message Curl Format](/Other/curl.html).
...
You can send an embed using the [Message Curl Format](/Other/curl).

</Callout>

**Function difficulty:** <Badge type="warning" text="Medium" vertical="middle" /> 

**Tags:** <Tag text="Await"/> <Tag text="Button"/> <Tag text="Interaction"/> <Tag text="Click"/>
