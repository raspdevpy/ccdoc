...
<Discord>
    <Message>
        !!exec $channelCooldown[5m;You're on cooldown!] You're not on cooldown!
    </Message>
    <Message bot>You're not on cooldown!</Message>
    <Message>
        !!exec $channelCooldown[5m;You're on cooldown! Still %mins%m remaining!]
        You're not on cooldown!
    </Message>
    <Message bot>You're on cooldown! Still 4m remaining!</Message>
</Discord>
...
**Tags:** <Tag text="Cooldown"/> <Tag text="Channel Cooldown"/> <Tag text="Limit"/>
