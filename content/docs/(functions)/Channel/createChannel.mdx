...
<Callout type="info" title={"Available Channel Types"}>

For a complete list of valid channel types, see [this reference page](/CodeReferences/ref.channel_types).
...
**Tags:** <Tag text="Channel"/> <Tag text="Create"/> <Tag text="Create Channel"/> <Tag text="Make Channel"/>
