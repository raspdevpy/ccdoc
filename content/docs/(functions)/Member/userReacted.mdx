...
<Discord>
    <Message>
        !!exec $wait[5s] $userReacted[;;;
        <img
            src="https://cdn.discordapp.com/emojis/1000917016724648007.webp?size=16"
            alt="DogSmile"
        ...
        <DiscordReactions>
            <DiscordReaction
                name="DogSmile"
                image="https://cdn.discordapp.com/emojis/1000917016724648007.webp"
                count={1}
                active
            />
        </DiscordReactions>
