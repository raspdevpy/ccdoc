...
<Discord>
    <Message>
        !!exec $wait[5s] $userReacted[;;;<Emoji src="https://cdn.discordapp.com/emojis/1000917016724648007.webp?size=32" />]
        <Reactions>
            <Reaction image="https://cdn.discordapp.com/emojis/1000917016724648007.webp?size=32" count="1" active />
        </Reactions>
    </Message>
