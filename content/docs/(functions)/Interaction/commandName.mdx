...
This function only works within the context of a [slash command](/Trigger/slash).
...
*   [Slash command](/Trigger/slash): Learn how to create and trigger slash commands.
