...
This variable returns the unique ID of the modal that activated the [modal trigger](/Trigger/modal).
...
You can only use `$modalID` **within** the context of a [modal trigger](/Trigger/modal).  It won't work anywhere else!
...
**Tags:** <Tag text="ModalID"/> <Tag text="Modal"/> <Tag text="Modal Id"/>