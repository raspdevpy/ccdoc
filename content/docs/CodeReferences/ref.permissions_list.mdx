---
title: "Understanding Channel, User, and Role Permissions"
---

<Callout title="Outdated" type="error">
    This page is outdated and will no longer be updated. Please use [this one](/Other/permission-list) instead.
</Callout>
