...
The reward that users will receive is 100$ with the [template economy](/Guide/4.template). Since the template economy uses the `money` user var to store a user's balance, we will contribute to that var.
