...
# Steps
## #1 Creating Command
Your first step, will be creating a new custom command, check this [page](/Guide/1.create#creating-custom-command)

## #2 Trigger Settings
In the trigger settings
1. Select the Type to be `Word`, you can know more about this trigger [here](/Trigger/word)
