...
![Video preview](https://i.imgur.com/MuE8xH7.gif)
...
<Callout type="info" title={"Related pages"}>
...
| [Button trigger](/Trigger/button) | detect button clicks |
| `$modal` | deploy a modal |
| [Modal trigger](/Trigger/modal) | catch submitted modals |
...
| [Complete embed](/Text/Embed/example) | create an embed |
