---
title: "Simple Slash Command: Confession"
---
...
To build an embed, we need to use [curl message format](/CodeReferences/ref.message_curl_format).
...
```
> You can see the full list [here](/CodeReferences/ref.message_curl_format)
