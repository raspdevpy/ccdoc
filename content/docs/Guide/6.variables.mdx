...
```
<Callout type="info" title={"Where are the variables saved?"}>

All variables are saved in our database. If you have privacy concerns, please read our [Privacy Policy](/Legal/policy).
