...
Minecraft
Fortnite
Terraria </DiscordMessage> <DiscordMessage bot author="Custom Command" roleColor="#0099ff">
Thanks for creating a poll! </DiscordMessage> </DiscordMessages>
...
This is the original message. </DiscordMessage> <DiscordMessage bot author="Custom Command" roleColor="#0099ff">
A message was forwarded! </DiscordMessage> </DiscordMessages>
...
Message triggers can still use message parameters.

For example, suppose you create a **Starts with** trigger for:
...
The trigger matches `!hug`, while the remaining content can be accessed using the message functions.

For example, `$message[2]` can be used to retrieve the first parameter after the trigger.

This allows you to create commands such as:
