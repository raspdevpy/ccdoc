...
*   **Use the Template:**  A template ensures consistency across all function documentation. You can find the template [here](/Contribution_Info/function_template).
...
4.  **Use the Template and Populate It:** Use the [template](/Contribution_Info/function_template) as a starting point. Fill in the template with accurate and detailed information about the function.  You can also refer to existing function documentation files for inspiration.
